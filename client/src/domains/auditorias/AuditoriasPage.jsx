...
const AuditoriasPage = () => {
  ...
  const [mostrarNuevaAuditoria, setMostrarNuevaAuditoria] = useState(searchParams.get('action') === 'nueva');
  ...
  // Efecto para manejar el parámetro action de la URL
  useEffect(() => {
    if (searchParams.get('action') === 'nueva') {
      setMostrarNuevaAuditoria(true);
    }
  }, [searchParams]);
