...
const { requireAuth } = require('../auth/middleware/authentication');
const { requireRole } = require('../auth/middleware/authorization');
...
// =================== RUTAS PÚBLICAS ===================
// (Ninguna - todas las operaciones requieren autenticación)
...
// router.use('/:id/documentos', require('./documentos.routes'));

// =================== RUTAS DE ETAPAS ESPECÍFICAS ===================
// TODO: Implementar rutas específicas para cada etapa
// router.use('/:id/etapa1', require('./workflow/etapa1.routes'));
// router.use('/:id/etapa2', require('./workflow/etapa2.routes'));
// etc...
